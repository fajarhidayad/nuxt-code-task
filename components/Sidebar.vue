...
<template>
  <aside class="sidebar">
    ...
    <ul class="sidebar-list">
      <li>
        <NuxtLink to="/" activeClass="sidebar-list__item-active" class="sidebar-list__item">
      ...
      <li>
        <NuxtLink to="/archive" active-class="sidebar-list__item-active" class="sidebar-list__item">
